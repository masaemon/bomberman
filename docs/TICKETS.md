...
- [x] 爆弾・爆発範囲からの逃避
- [x] 安全経路の計算
- [x] **拡張機能**: 敵同士も攻撃対象（最も近いターゲットを追跡）
- [x] **拡張機能**: 積極的な爆弾設置（壁破壊、ランダム設置）
...
### ✅ BUGFIX-001: 爆弾すり抜け機能
**Status**: Completed
**Description**: クラシックボンバーマンの仕様を実装
- [x] 爆弾設置直後はそのタイルをすり抜け可能
- [x] タイルから完全に離れたら通常の衝突判定に戻る
- [x] プレイヤーと敵の両方に適用

### ✅ BUGFIX-002: リスタート機能
**Status**: Completed
**Description**: ゲーム中いつでもリスタート可能
- [x] PCではRキーでリスタート
- [x] モバイルではHUD右側タップでリスタート
- [x] ゲームプレイ中・ゲームオーバー後どちらでも動作

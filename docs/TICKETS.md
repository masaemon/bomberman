...
- [ ] デバイス検出機能（モバイル/デスクトップ）
- [ ] フィールドサイズ設定（30×15、全デバイス共通）
- [ ] タイルサイズ設定（デバイス別に自動調整）
- [ ] プレイヤー初期ステータス
- [ ] AI数・初期ステータス
- [ ] フィールド縮小設定
...
**Status**: Todo
**Estimate**: 3h
**Description**: モバイル用の仮想コントローラーUI
- [ ] `src/ui/VirtualController.ts`作成
- [ ] 仮想十字キー（画面左下）
  - [ ] 上下左右ボタン配置
  - [ ] タッチイベント処理
  - [ ] 視覚フィードバック
